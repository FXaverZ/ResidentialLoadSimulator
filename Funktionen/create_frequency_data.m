...
% Frequency = frequ_ramp(Frequency, t_points(1), t_points(4), 48);
% Frequency = frequ_const(Frequency, t_points(4), t_points(7), 48);
% Frequency = frequ_ramp(Frequency, t_points(7), t_points(10), 50);
