...
% the user:
[season_fut, ~, ~] = day2sim_parameter(Model, act_day + Model.Seasons_Overlap - 1);
[season_pas, ~, ~] = day2sim_parameter(Model, act_day - Model.Seasons_Overlap);
...
if ~strcmp(season, season_fut)
	...
	season_1.parafilemname = ['Param',sep,season,sep,weekd];
	season_1.factor = 0;
	season_2.season = season_fut;
	season_2.parafilemname = ['Param',sep,season_fut,sep,weekd];
	season_2.factor = 0;
	...
	season_1.parafilemname = ['Param',sep,season_pas,sep,weekd];
	season_1.factor = 0;
	season_2.season = season;
	season_2.parafilemname = ['Param',sep,season,sep,weekd];
	season_2.factor = 0;
